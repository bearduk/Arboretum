...
| Date | Note |
|------|------|
| 2026-04-03 | Folder assessed; `project-notes.txt` archived; workbook structure and column fill-rates captured; `.venv` created locally with OpenPyXL for analysis; this `AGENTS.md` added; `.gitignore` and `requirements.txt` (openpyxl, pyproj) added for a future GitHub-based build. |
...
| 2026-04-03 | Added root `README.md` for maintainers (install, export, spreadsheet rules, column/map fragility, publishing handoff); `AGENTS.md` cross-links and spreadsheet contract summary. |
